...
@protocol HWBProgressHUDDelegate;


typedef enum {
    /** Progress is shown using an UIActivityIndicatorView. This is the default. */
    HWBProgressHUDModeIndeterminate,
    /** Progress is shown using a round, pie-chart like, progress view. */
    HWBProgressHUDModeDeterminate,
    /** Progress is shown using a ring-shaped progress view. */
    HWBProgressHUDModeAnnularDeterminate,
    /** Shows a custom view */
    HWBProgressHUDModeCustomView,
    /** Shows only labels */
    HWBProgressHUDModeText
} HWBProgressHUDMode;

typedef enum {
    /** Opacity animation */
    HWBProgressHUDAnimationFade,
    /** Opacity + scale animation */
    HWBProgressHUDAnimationZoom,
    HWBProgressHUDAnimationZoomOut = HWBProgressHUDAnimationZoom,
    HWBProgressHUDAnimationZoomIn
} HWBProgressHUDAnimation;
...
typedef void (^HWBProgressHUDCompletionBlock)();
#endif
...
@interface HWBProgressHUD : UIView
 ...
 * @see showAnimated:whileExecutingBlock:onQueue:completion:
 */
- (void)showAnimated:(BOOL)animated whileExecutingBlock:(dispatch_block_t)block completionBlock:(HWBProgressHUDCompletionBlock)completion;
 ...
 */
@property (copy) HWBProgressHUDCompletionBlock completionBlock;
...
@protocol HWBProgressHUDDelegate <NSObject>
 ...
 */
- (void)hudWasHidden:(HWBProgressHUD *)hud;
 ...
 */
@interface HWBRoundProgressView : UIView
