...
#import "LYNavTabBar.h"
#import "LYCommonMacro.h"
#import "LYPopView.h"

@interface LYNavTabBar () <LYPopViewDelegate>
{
    ...
    LYPopView       *_popView;              // when item menu, will show this view
    
    NSMutableArray  *_items;                // LYNavTabBar pressed item
...
{
    _items = [@[] mutableCopy];
    _arrowImage = [UIImage imageNamed:LYNavTabbarSourceName(@"arrow.png")];
    ...
    if (pop)
    {
        ...
        [UIView animateWithDuration:0.5f animations:^{
            ...
            [UIView animateWithDuration:0.2f animations:^{
                if (!_popView)
                {
                    _popView = [[LYPopView alloc] initWithFrame:CGRectMake(DOT_COORDINATE, NAVIGATION_BAR_HEIGHT, SCREEN_WIDTH, self.frame.size.height - NAVIGATION_BAR_HEIGHT)];
...
#pragma mark - LYFunctionView Delegate Methods
#pragma mark -
