...
#import "LYNavTabBarController.h"
#import "LYCommonMacro.h"
#import "LYNavTabBar.h"

@interface LYNavTabBarController () <UIScrollViewDelegate, LYNavTabBarDelegate>
{
    NSInteger       _currentIndex;              // current page index
    NSMutableArray  *_titles;                   // array of children view controller's title
    
    LYNavTabBar     *_navTabBar;                // NavTabBar: press item on it to exchange view
    UIScrollView    *_mainView;                 // content view
}

@end

@implementation LYNavTabBarController
...
- (void)viewInit
{
    ...
    _navTabBar = [[LYNavTabBar alloc] initWithFrame:CGRectMake(DOT_COORDINATE, 25, SCREEN_WIDTH, NAV_TAB_BAR_HEIGHT) showArrowButton:_showArrowButton];
...
#pragma mark - LYNavTabBarDelegate Methods
#pragma mark -
