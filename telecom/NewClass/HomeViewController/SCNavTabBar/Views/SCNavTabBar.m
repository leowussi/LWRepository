...
- (void)showLineWithButtonWidth:(CGFloat)width
{
    ...
    _line.backgroundColor = COLOR(253, 146, 35);
...
- (CGFloat)contentWidthAndAddNavTabBarItemsWithButtonsWidth:(NSArray *)widths
{
    ...
    for (NSInteger index = 0; index < [_itemTitles count]; index++)
    {
        ...
        [button setTitleColor:COLOR(186, 186, 186) forState:UIControlStateNormal];
        [button setTitleColor: COLOR(253, 146, 35) forState:UIControlStateSelected];
...
- (void)itemPressed:(UIButton *)button
{
    ...
    [_delegate itemDidSelectedWithIndex:index WithButton:button];
}
...
//    }
    ...
    for (NSString *tit in titles) {
        [widths addObject:@(SCREEN_WIDTH/3)];
...
- (void)setCurrentItemIndex:(NSInteger)currentItemIndex
{
    ...
    [self DidSelectedWithIndex:currentItemIndex];
