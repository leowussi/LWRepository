...
//}
//
//#pragma mark --- #warning - 此处目的是获得第一相应者，但非常耗系统性能。
...
//    }
//    _currentPointY=self.contentOffset.y;
...
//    self.contentOffset = CGPointMake(self.contentOffset.x, h);
//    [self setScrollIndicatorInsets:self.contentInset];
//    _priorInsetSaved = NO;
//    [UIView commitAnimations];
//}
...
//    }
//    NSLog(@"keyboardRect ==== %f",keyboardRect.origin.y);
//    return keyboardRect;
//}
@end
