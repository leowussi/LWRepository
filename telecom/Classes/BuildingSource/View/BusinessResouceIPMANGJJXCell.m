//
//  BusinessResouceIPMANGJJXCell.m
//  telecom
//
...
#import "BusinessResouceIPMANGJJXCell.h"
#import "BusinessResourceModel.h"
@implementation BusinessResouceIPMANGJJXCell
...
- (void)configModel:(BusinessResourceModel *)model
{
    ...
    self.label12.text = model.tjCirAvaliable;
    self.label13.text = model.range;
