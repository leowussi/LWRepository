...
#import "EditDrivingRecordController.h"
#import "ImageAndVideoPicker.h"
#import "FileModel.h"
#import "SelfImgeView.h"
#import "Masonry.h"
@interface EditDrivingRecordController ()<ImageAndVideoPickerDelegate,DeleteBtnInImageViewDelegate>
@property (nonatomic,strong) ImageAndVideoPicker *picker;
@property (nonatomic,strong) NSMutableArray *fileArray;
@end

@implementation EditDrivingRecordController
...
- (void)createUI
{
    self.navigationItem.title = @"编辑行车记录";
