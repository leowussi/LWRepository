...
#define TEXT_COLOR          (RGBCOLOR(83, 161, 225))

@interface AddSGYY ()<UITextFieldDelegate>
{
...
- (void)viewDidLoad
{
    ...
    m_scroll = [[UIScrollView alloc] initWithFrame:RECT(0, NAV_H+STATUS_H, APP_W, SCREEN_H-NAV_H-STATUS_H)];
    ...
    UIButton* commitBtn = [[UIButton alloc] initWithFrame:RECT(10, y, APP_W-20, 36)];
    [commitBtn setBackgroundImage:color2Image(TEXT_COLOR) forState:0];//COLOR(74, 130, 198)
...
//    commitBtn.layer.cornerRadius = 5;
    ...
    commitBtn.titleLabel.font = [UIFont systemFontOfSize:20.0f];
...
- (CGFloat)addBanner1:(CGFloat)top_y
{
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:RECT(0, pos_y, ban.fw, 3)];
    lineView.backgroundColor = RGBCOLOR(240, 145, 38);
    [ban addSubview:lineView];
    
    UILabel *lbt = newLabel(ban, @[@(btag++), RECT_OBJ(10,pos_y+(ROW_H-Font2)/2 , ban.fw/2, Font2), TEXT_COLOR, FontB(Font2), @"工程名称"]);
    newTextField(ban, @[@(TAG_TEXT_NAME), RECT_OBJ(80, pos_y+2, ban.fw-88, ROW_H-4), COLOR(69, 69, 69), FontB(Font3), @"请填写工程名称", @""]);
    
    pos_y = ROW_H*1;
    lbt = newLabel(ban, @[@(btag++), RECT_OBJ(10, pos_y+(ROW_H-Font2)/2, ban.fw/2, Font2),TEXT_COLOR, FontB(Font2), @"订单号"]);
    newTextField(ban, @[@(TAG_TEXT_CODE), RECT_OBJ(80, pos_y+2, ban.fw-88, ROW_H-4), COLOR(69, 69, 69), FontB(Font3), @"请填写工程编号", self.orderNo]);
    
    
    
    pos_y = ROW_H*2;
    lbt = newLabel(ban, @[@(btag++), RECT_OBJ(10, pos_y+10, ban.fw/2, Font2),TEXT_COLOR, FontB(Font2), @"开始日期"]);
    ...
    lbt = newLabel(ban, @[@(btag++), RECT_OBJ(ban.fw/2+10, pos_y+10, ban.fw/2, Font2),TEXT_COLOR, FontB(Font2), @"开始时间"]);
    ...
    pos_y = ROW_H*3;
    lbt = newLabel(ban, @[@(btag++), RECT_OBJ(10, pos_y+10, ban.fw/2, Font2),TEXT_COLOR, FontB(Font2), @"结束日期"]);
    ...
    lbt = newLabel(ban, @[@(btag++), RECT_OBJ(ban.fw/2+10, pos_y+10, ban.fw/2, Font2),TEXT_COLOR, FontB(Font2), @"结束时间"]);
...
- (CGFloat)addBanner2:(CGFloat)top_y
{
    ...
    UILabel* lbt = newLabel(ban, @[@(btag++), RECT_OBJ(10, pos_y+10, ban.fw, Font2),TEXT_COLOR, FontB(Font2), @"机房"]);
    ...
    pos_y = ROW_H*1;
    lbt = newLabel(ban, @[@(btag++), RECT_OBJ(10, pos_y+10, ban.fw, Font2),TEXT_COLOR, FontB(Font2), @"进入原因"]);
...
- (CGFloat)addBanner3:(CGFloat)top_y
{
    ...
    newLabel(ban, @[@(btag++), RECT_OBJ(10, pos_y+(ROW_H-Font2)/2, ban.fw/2, Font2),TEXT_COLOR, FontB(Font2), @"施工单位"]);
    newTextField(ban, @[@(TAG_TEXT_COM), RECT_OBJ(85, pos_y+2, ban.fw-93, ROW_H-4), COLOR(69, 69, 69), FontB(Font3), @"请填写施工单位", @""]);
    
//    UILabel* lbt = newLabel(ban, @[@(btag++), RECT_OBJ(10, pos_y+10, ban.fw, Font2),TEXT_COLOR, FontB(Font2), @"提交部门"]);
...
//    [self newSelectBtn:ban Tag:TAG_DEPT_BTN Frame:RECT(1, pos_y+1, ban.fw-2, ROW_H-2)];
    ...
    pos_y = ROW_H*1;
    newLabel(ban, @[@(btag++), RECT_OBJ(10, pos_y+(ROW_H-Font2)/2, ban.fw/2, Font2),TEXT_COLOR, FontB(Font2), @"施工数量"]);
    ...
    pos_y = ROW_H*2;
     UILabel *remarkLabel = newLabel(ban, @[@(btag++), RECT_OBJ(10, pos_y+5, 75, Font2),TEXT_COLOR, FontB(Font2), @"备注信息"]);
    UITextView *remarkView = [[UITextView alloc] initWithFrame:RECT(remarkLabel.ex, remarkLabel.fy, ban.fw-10-remarkLabel.fw, ROW_H)];
    remarkView.font = [UIFont systemFontOfSize:14.0f];
    remarkView.text = [NSString stringWithFormat:@"订单号:%@,工单内容:%@",self.workInfo[@"orderNo"],self.workInfo[@"workContent"]];
    remarkView.font = [UIFont systemFontOfSize:11.0f];
    remarkView.textContainerInset = UIEdgeInsetsZero;
    [ban addSubview:remarkView];
