...
@interface TaskTypeBar ()<UIScrollViewDelegate>
{
...
//        m_scroll.pagingEnabled = NO; //自动滚动到subview的边界
...
{
    _typeList = (NSMutableArray *)[typeList retain];
...
//        NSLog(@"%f",m_scroll.contentSize.height);
